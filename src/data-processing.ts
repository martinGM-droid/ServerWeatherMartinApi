export type ClassCash<INTERFACE> = INTERFACE | []
...
export function parseAndFormatApiDataPlace(cashResponse: ClassCash<Place> ) {
      if(cashResponse.length === 0) return []
      const features = cashResponse[0].features
